...
'''import script for complaints-CPD-witnesses-cms_2019-2022_2022-09_p031093'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_cpd_witness.csv',
        'output_file': 'output/complaints-CPD-witnesses-cms_2019-2022_2022-09_p031093.csv.gz',
        'metadata_file': 'output/metadata_complaints-CPD-witnesses-cms_2019-2022_2022-09_p031093.csv.gz',
        'column_names_key': 'complaints-CPD-witnesses-cms_2019-2022_2022-09_p031093',
        }
