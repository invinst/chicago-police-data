...
'''import script for roster_1969-2023_2023-07_p858785'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/P858785_CPD_employees_2015-YTD_(2).xlsx',
        'output_file': 'output/roster_1969-2023_2023-07_p858785.csv.gz',
        'metadata_file': 'output/metadata_roster_1969-2023_2023-07_p858785.csv.gz',
        'column_names_key': 'roster_1969-2023_2023-07_p858785',
...
if __name__ == "__main__":
    ...
    df = pd.read_excel(cons.input_file, sheet_name='DataSet I')
