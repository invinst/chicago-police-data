...
'''assign-unique-ids script for roster_1969-2023_2023-07_p858785'''
...
def get_setup():
    ...
    args = {
        ...
        'id_cols': ['first_name', 'last_name', 'middle_initial', 
                    'birth_year', 'race', 'gender', 'appointed_date', 
                    'resignation_date', 'first_name_NS', 'last_name_NS'],
        'incident_cols' : ['rank', 'unit'],
        'id': 'roster_1969-2023_2023-07_p858785_ID',
        }
