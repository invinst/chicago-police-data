...
'''import script for complaints-complaints_1967-1999_2016-12_'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_complaints-complaints_1967-1999_2016-12.csv.gz',
        'column_names_key': 'complaints-complaints_1967-1999_2016-12_',
        'keep_columns': ['CASE_NUMBER', 'INCIDENT_DATE', 'INCIDENT_TIME',
                         'DATE_COMPLAINT_RECVD', 'CASE_STATUS', 'DATE_CLOSED',
                         'INVESTIGATION_UNIT', 'INCIDENT_BEAT',
                         'INCIDENT LOCATION']
        }
