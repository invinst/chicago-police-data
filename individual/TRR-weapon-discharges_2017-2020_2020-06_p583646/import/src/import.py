...
'''import script for TRR-weapon-discharges_2017-2020_2020-06_p583646'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/TRR-weapon-discharges_2017-2020_2020-06_p583646.csv.gz',
        'metadata_file': 'output/metadata_TRR-weapon-discharges_2017-2020_2020-06_p583646.csv.gz',
        'column_names_key': 'TRR-weapon-discharges_2017-2020_2020-06_p583646',
        'sheet_name': 'WeaponDischarges'
        }
...
if __name__ == "__main__":
    ...
    df = pd.read_excel(cons.input_file, sheet_name='WeaponDischarges')
