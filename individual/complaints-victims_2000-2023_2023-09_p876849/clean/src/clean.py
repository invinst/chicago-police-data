...
'''clean script for complaints-victims_2000-2023_2023-09_p876849'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/complaints-victims_2000-2023_2023-09_p876849.csv.gz',
        'output_file': 'output/complaints-victims_2000-2023_2023-09_p876849.csv.gz'
        }
...
if __name__ == "__main__":
    ...
    fill_cols = ['role', 'race', 'gender']

    for col in fill_cols:
        df[col] = df.groupby('cr_id')[col].ffill()

    df = df.loc[df['role'].str.contains("Subject").fillna(False)]
