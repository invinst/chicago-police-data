...
'''import script for TRR-statuses_2021-2023_2023-10_p877988'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/TRR-statuses_2021-2023_2023-10_p877988.csv.gz',
        'metadata_file': 'output/metadata_TRR-statuses_2021-2023_2023-10_p877988.csv.gz',
        'column_names_key': 'TRR-statuses_2021-2023_2023-10_p877988',
        'sheet_name': ' Supervisor Review Info.',
    }
