...
'''import script for complaints-investigators-clear_2000-2019_2021-07_p21060299'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/clear_investigator REDACTED.csv',
        'output_file': 'output/complaints-investigators-clear_2000-2019_2021-07_p21060299.csv.gz',
        'metadata_file': 'output/metadata_complaints-investigators-clear_2000-2019_2021-07_p21060299.csv.gz',
        'column_names_key': 'complaints-investigators-clear_2000-2019_2021-07_p21060299',
        }
