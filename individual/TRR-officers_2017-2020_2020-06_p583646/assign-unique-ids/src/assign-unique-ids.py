...
'''assign-unique-ids script for TRR-officers_2017-2020_2020-06_p583646'''
...
def get_setup():
    ...
    args = {
        ...
        'current_cols': ['rank', 'unit', 'unit_detail'],
...
agg_df = aggregate_data(df, cons.id, cons.id_cols, current_cols=cons.current_cols, time_col="trr_date")
