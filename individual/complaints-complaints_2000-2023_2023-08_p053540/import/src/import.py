...
'''import script for complaints-complaints_2000-2023_2023-08_p053540'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/BlockedAddressAllCasetoDate.xlsx',
        'output_file': 'output/complaints-complaints_2000-2023_2023-08_p053540.csv.gz',
        'metadata_file': 'output/metadata_complaints-complaints_2000-2023_2023-08_p053540.csv.gz',
        'column_names_key': 'complaints-complaints_2000-2023_2023-08_p053540',
        }
