...
'''export script for complaints-complaints_2000-2023_2023-08_p053540'''
...
def get_setup():
    ...
    args = {
        ...
        'keep_cols': ['cr_id', 'address', 'incident_date','case_type','incident_time','complaint_date','closed_date','street_number','street_direction',
            'street_name','apartment_number','city','state','zip','beat','location_code', 'investigating_agency', 'complainant_type']
        }
