...
'''import script for complaints-investigators-cms_2019-2020_2020-07'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_investigator - 7.27.2020.csv',
        'output_file': 'output/complaints-investigators-cms_2019-2020_2020-07.csv.gz',
        'metadata_file': 'output/metadata_complaints-investigators-cms_2019-2020_2020-07.csv.gz',
        'column_names_key': 'complaints-investigators-cms_2019-2020_2020-07',
        }
