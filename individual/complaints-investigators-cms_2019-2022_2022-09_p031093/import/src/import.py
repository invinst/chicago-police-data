...
'''import script for complaints-investigators-cms_2019-2022_2022-09_p031093'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_invetigator.xlsx',
        'output_file': 'output/complaints-investigators-cms_2019-2022_2022-09_p031093.csv.gz',
        'metadata_file': 'output/metadata_complaints-investigators-cms_2019-2022_2022-09_p031093.csv.gz',
        'column_names_key': 'complaints-investigators-cms_2019-2022_2022-09_p031093',
        }
