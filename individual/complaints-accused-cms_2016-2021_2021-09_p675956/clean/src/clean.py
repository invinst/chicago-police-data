...
# suffix jr joined without space, add it back
jr_mask = df.last_name.str.endswith("JR").fillna(False)
df.loc[jr_mask, "last_name"] = df.loc[jr_mask, "last_name"].str[0:-2] + " JR"
