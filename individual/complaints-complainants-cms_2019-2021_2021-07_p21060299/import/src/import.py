...
'''import script for complaints-complainants-cms_2019-2021_2021-07_p21060299'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_complainant.csv',
        'output_file': 'output/complaints-complainants-cms_2019-2021_2021-07_p21060299.csv.gz',
        'metadata_file': 'output/metadata_complaints-complainants-cms_2019-2021_2021-07_p21060299.csv.gz',
        'column_names_key': 'complaints-complainants-cms_2019-2021_2021-07_p21060299',
        }
