...
'''import script for complaints-victims-clear_2000-2019_2021-07_p21060299'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/clear_subject.csv',
        'output_file': 'output/complaints-victims-clear_2000-2019_2021-07_p21060299.csv.gz',
        'metadata_file': 'output/metadata_complaints-victims-clear_2000-2019_2021-07_p21060299.csv.gz',
        'column_names_key': 'complaints-victims-clear_2000-2019_2021-07_p21060299',
        }
