...
'''import script for complaints-complaints_2000-2021_2021-07'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/clear_accused REDACTED.csv',
        'output_file': 'output/complaints-accused-clear_2000-2021_2021-07.csv.gz',
        'metadata_file': 'output/metadata_complaints-accused-clear_2000-2021_2021-07.csv.gz',
        'column_names_key': 'complaints-accused-clear_2000-2021_2021-07',
        }
