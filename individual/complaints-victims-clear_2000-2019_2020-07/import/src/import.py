...
'''import script for complaints-victims-clear_2000-2019_2020-07'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/clear_subject - 7.27.2020.csv',
        'output_file': 'output/complaints-victims-clear_2000-2019_2020-07.csv.gz',
        'metadata_file': 'output/metadata_complaints-victims-clear_2000-2019_2020-07.csv.gz',
        'column_names_key': 'complaints-victims-clear_2000-2019_2020-07',
        }
