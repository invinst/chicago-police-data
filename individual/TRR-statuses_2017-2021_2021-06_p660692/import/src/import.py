...
'''import script for TRR-statuses_2017-2021_2021-06_p660692'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_TRR-statuses_2017-2021_2021-06_p660692.csv.gz',
        'column_names_key': 'TRR-statuses_2017-2021_2021-06_p660692',
        'sheet_name': "Supervisor's Review Info "
        }
...
if __name__ == "__main__":
    ...
    df = pd.read_excel(cons.input_file, sheet_name="Supervisor's Review Info ")
