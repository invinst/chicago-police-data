...
'''assign-unique-ids script for TRR-statuses_2017-2021_2021-06_p660692'''
...
def get_setup():
    ...
    args = {
        ...
        'id_cols': ['first_name_NS', 'last_name_NS', 'appointed_date', 'birth_year', 'gender', 'race'],
        'incident_cols' : ['rank'],
        'list_cols': ['trr_id'],
        'id': 'TRR-statuses_2017-2021_2021-06_p660692_ID',
        }
