...
'''import script for complaints-civilian-witnesses-clear_2000-2020_2020-07'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/clear_civilian_witness_-_7.27.2020.csv',
        'output_file': 'output/complaints-civilian-witnesses-clear_2000-2020_2020-07.csv.gz',
        'metadata_file': 'output/metadata_complaints-civilian-witnesses-clear_2000-2020_2020-07.csv.gz',
        'column_names_key': 'complaints-civilian-witnesses-clear_2000-2020_2020-07',
        }
