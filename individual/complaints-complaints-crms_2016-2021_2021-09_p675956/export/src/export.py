...
'''export script for complaints-complaints-crms_2016-2021_2021-09_p675956.'''
...
def get_setup():
    ...
    args = {
        ...
        'keep_cols': ['cr_id', 'address', 'street_number','street_direction',
            'street_name','city','state','zip',
            'beat','location_code','incident_date','complaint_date','closed_date', 'investigating_agency',
            'complainant_type']
        }
