...
'''export script for roster_1985-2023_2023-11_p891976'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/roster_1985-2023_2023-11_p891976.csv.gz',
        ...
        'output_profiles_file': 'output/roster_1985-2023_2023-11_p891976_profiles.csv.gz'
        }
