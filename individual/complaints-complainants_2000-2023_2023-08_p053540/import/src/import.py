...
'''import script for complaints-complainants_2000-2023_2023-08_p053540'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/AllComplainants.xlsx',
        'output_file': 'output/complaints-complainants_2000-2023_2023-08_p053540.csv.gz',
        'metadata_file': 'output/metadata_complaints-complainants_2000-2023_2023-08_p053540.csv.gz',
        'column_names_key': 'complaints-complainants_2000-2023_2023-08_p053540',
        }
