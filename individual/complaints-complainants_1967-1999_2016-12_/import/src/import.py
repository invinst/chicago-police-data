...
'''import script for complaints-complainants_1967-1999_2016-12_'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/complaints-complainants_1967-1999_2016-12.csv.gz',
        'metadata_file': 'output/metadata_complaints-complainants_1967-1999_2016-12.csv.gz',
        'column_names_key': 'complaints-complainants_1967-1999_2016-12_',
...
df = df[df['officer_or_non']=='COMPLAINING_WITNESS']
log.info('{} rows with officer_or_non = COMPLAINING_WITNESS selected'.format(df.shape[0]))
