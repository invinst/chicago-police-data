...
'''assign-unique-ids script for TRR-officers_2021-2023_2023-10_p877988'''
...
def get_setup():
    ...
    args = {
        ...
        'id_cols': ['first_name', 'last_name', 'middle_initial', 'race', 'gender', 'birth_year',
                    'appointed_date', 'first_name_NS', 'last_name_NS', 'middle_initial2'],
        'incident_cols' : ['star1', 'star2', 'current_unit', 'current_rank', 'current_beat', 'height', 'weight', 'member_assigned_beat'],
        'id': 'TRR-officers_2021-2023_2023-10_p877988_ID',
        }
