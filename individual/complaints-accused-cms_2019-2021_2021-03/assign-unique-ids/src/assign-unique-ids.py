...
def get_setup():
    ...
    args = {
        'input_file': 'input/complaints-accused-cms_2019-2021_2021-03.csv.gz',
        'output_file': 'output/complaints-accused-cms_2019-2021_2021-03.csv.gz',
        'output_profiles_file': 'output/complaints-accused-cms_2019-2021_2021-03_profiles.csv.gz',
        'id_cols': [
        ...
        'list_cols': ['cr_id'],
        'id': 'complaints-accused-cms_2000-2021_2021-03_ID',
        }
...
profiles_df = df.loc[(df.first_name != 'UNKNOWN') & (df.first_name != 'UNK'), [cons.id, 'cr_id'] + cons.id_cols + cons.incident_cols]\
