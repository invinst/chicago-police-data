...
'''import script for complaints-investigators-cms_2019-2021_2021-07_p21060299'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_investigator REDACTED.csv',
        'output_file': 'output/complaints-investigators-cms_2019-2021_2021-07_p21060299.csv.gz',
        'metadata_file': 'output/metadata_complaints-investigators-cms_2019-2021_2021-07_p21060299.csv.gz',
        'column_names_key': 'complaints-investigators-cms_2019-2021_2021-07_p21060299',
        }
