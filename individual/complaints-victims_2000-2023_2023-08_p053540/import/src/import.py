...
'''import script for complaints-victims_2000-2023_2023-08_p053540'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/AllSubject_Victim_.xlsx',
        'output_file': 'output/complaints-victims_2000-2023_2023-08_p053540.csv.gz',
        'metadata_file': 'output/metadata_complaints-victims_2000-2023_2023-08_p053540.csv.gz',
        'column_names_key': 'complaints-victims_2000-2023_2023-08_p053540',
        }
