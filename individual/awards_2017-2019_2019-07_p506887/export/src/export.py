...
def get_setup():
    ...
    args = {
        ...
        'input_profiles_file': 'input/awards_2017-2019_2019-07_p506887_profiles.csv.gz',
        'output_file': 'output/awards_2017-2019_2019-07_p506887.csv.gz',
        'output_profiles_file': 'output/awards_2017-2019_2019-07_p506887_profiles.csv.gz',
        # 'export_cols': [
