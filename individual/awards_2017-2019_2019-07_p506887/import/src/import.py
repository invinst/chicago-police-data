...
def get_setup():
    ...
    args = {
        'input_file': 'input/P506887_Sinclair_Rajiv_Awards Data.xlsx',
        'output_file': 'output/awards_2017-2019_2019-07_p506887.csv.gz',
        'metadata_file': 'output/metadata_awards_2017-2019_2019-07_p506887csv.gz',
        'column_names_key': 'awards_2017-2019_2019-07_p506887'
        }
