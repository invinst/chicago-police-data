...
'''import script for complaints-investigators_2000-2018_2018-03_18-060-157'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/FOIA_Data_157_(Stecklow)_1.1.xlsx',
        'output_file': 'output/complaints-investigators_2000-2018_2018-03.csv.gz',
        'metadata_file': 'output/metadata_complaints-investigators_2000-2018_2018-03.csv.gz',
        'column_names_key': 'complaints-investigators_2000-2018_2018-03_18-060-157'
        }
