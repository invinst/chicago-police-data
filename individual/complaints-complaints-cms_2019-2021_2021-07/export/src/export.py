...
'''export script for complaints-complaints-cms_2019-2021_2021-07'''
...
def get_setup():
    ...
    args = {
        ...
        'keep_cols': ['cr_id', 'address', 'incident_time',
            'street_number','street_direction','street_name','apartment_number',
