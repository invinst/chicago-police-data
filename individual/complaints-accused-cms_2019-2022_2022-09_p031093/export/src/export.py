...
'''export script for complaints-accused-cms_2019-2022_2022-09_p031093'''
...
def get_setup():
    ...
    args = {
        ...
        'input_profiles_file': 'input/complaints-accused-cms_2019-2022_2022-09_p031093_profiles.csv.gz',
...
if __name__ == "__main__":
    ...
    no_merge_mask = profiles_df.first_name_NS.isnull() | \
        profiles_df.last_name_NS.isnull() | \
        profiles_df.first_name_NS.isin(not_officer_names) 
