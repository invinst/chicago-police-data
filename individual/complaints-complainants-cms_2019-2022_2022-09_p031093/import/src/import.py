...
'''import script for complaints-complainants-cms_2019-2022_2022-09_p031093'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/complaints-complainants-cms_2019-2022_2022-09_p031093.csv.gz',
        'metadata_file': 'output/metadata_complaints-complainants-cms_2019-2022_2022-09_p031093.csv.gz',
        'column_names_key': 'complaints-complainants-cms_2019-2022_2022-09_p031093',
        }
