...
'''import script for complaints-civilian-witnesses-cms_2019-2022_2022-09_p031093'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/complaints-civilian-witnesses-cms_2019-2022_2022-09_p031093.csv.gz',
        'metadata_file': 'output/metadata_complaints-civilian-witnesses-cms_2019-2022_2022-09_p031093.csv.gz',
        'column_names_key': 'complaints-civilian-witnesses-cms_2019-2022_2022-09_p031093',
        }
