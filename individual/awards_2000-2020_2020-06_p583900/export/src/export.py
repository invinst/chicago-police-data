...
def get_setup():
    ...
    args = {
        ...
        'output_profiles_file': 'output/awards_2000-2020_2020-06_p583900_profiles.csv.gz',
        # 'export_cols': [
...
po_ranks = [rank.split("-")[1] for rank in po_ranks]
maybe_po_ranks = [rank.split("-")[1] for rank in maybe_po_ranks]
