...
'''import script for TRR-subject-weapons_2021-2023_2023-10_p877988'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/TRR-subject-weapons_2021-2023_2023-10_p877988.csv.gz',
        'metadata_file': 'output/metadata_TRR-subject-weapons_2021-2023_2023-10_p877988.csv.gz',
        'column_names_key': 'TRR-subject-weapons_2021-2023_2023-10_p877988',
        'sheet_name': 'Jan1-2021-Sep15-2023 TRR',
        'keep_cols': ['REPORT NO', 'EVENT_NO', "RD_NO", "SUBJECT_ARMED", "SUBJECTARMEDWITH", "SUBJECT_WEAPON_USE", "Subject Weapon"]
    }
