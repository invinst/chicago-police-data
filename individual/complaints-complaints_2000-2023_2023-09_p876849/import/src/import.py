...
'''import script for complaints-complaints_2000-2023_2023-09_p876849'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_complaints-complaints_2000-2023_2023-09_p876849.csv.gz',
        'column_names_key': 'complaints-complaints_2000-2023_2023-09_p876849',
        }
...
if __name__ == "__main__":
    ...
    df = pd.read_excel(cons.input_file, sheet_name="CR_Info")
