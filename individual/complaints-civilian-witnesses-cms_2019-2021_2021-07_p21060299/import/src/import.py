...
'''import script for complaints-civilian-witnesses-cms_2019-2021_2021-07_p21060299'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_civilian_witness.csv',
        'output_file': 'output/complaints-civilian-witnesses-cms_2019-2021_2021-07_p21060299.csv.gz',
        'metadata_file': 'output/metadata_complaints-civilian-witnesses-cms_2019-2021_2021-07_p21060299.csv.gz',
        'column_names_key': 'complaints-civilian-witnesses-cms_2019-2021_2021-07_p21060299',
        }
