...
'''import script for complaints-investigators_1967-1999_2016-12_'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_complaints-investigators_1967-1999_2016-12.csv.gz',
        'column_names_key': 'complaints-investigators_1967-1999_2016-12_',
        'keep_columns': ['CASE_NUMBER', 'INVESTIGATORS NAME']
        }
