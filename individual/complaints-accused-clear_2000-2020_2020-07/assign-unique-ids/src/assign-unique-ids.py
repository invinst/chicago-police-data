...
def get_setup():
    ...
    args = {
        'input_file': 'input/complaints-accused-clear_2000-2020_2020-07.csv.gz',
        'output_file': 'output/complaints-accused-clear_2000-2020_2020-07.csv.gz',
        'output_profiles_file': 'output/complaints-accused-clear_2000-2020_2020-07_profiles.csv.gz',
        'id_cols': [
            'first_name', 'last_name', 'first_name_NS', 'last_name_NS',
            'middle_initial','middle_initial2', 'suffix_name',
            'birth_year', 'race', 'gender', 'appointed_date'
            ],
        'incident_cols' : ['rank', 'current_unit', 'star'],
        'list_cols': ['cr_id'],
        'id': 'complaints-accused-clear_2000-2020_2020-07_ID',
        }
...
profiles_df = aggregate_data(profiles_df, cons.id, 
                            cons.id_cols, 
