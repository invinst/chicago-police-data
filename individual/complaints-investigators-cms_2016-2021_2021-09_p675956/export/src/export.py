...
'''export script for complaints-investigators-cms_2016-2021_2021-09_p675956'''
...
def get_setup():
    ...
    args = {
        ...
        'input_profiles_file': 'input/complaints-investigators-cms_2016-2021_2021-09_p675956_profiles.csv.gz',
