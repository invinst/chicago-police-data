#!usr/bin/env python3
#
# Author(s):    Ashwin Shamra (Invisible Institute)

'''clean script for TRR-main_2020-2021_2021-06_p660692'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/TRR-main_2020-2021_2021-06_p660692.csv.gz',
...
# some rd_nos are just "J", likely redacted, so replace with nan
df['rd_no'] = df['rd_no'].replace('J', pd.NA)
