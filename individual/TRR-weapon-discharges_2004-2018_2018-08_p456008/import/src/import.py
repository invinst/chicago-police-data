...
'''import script for TRR-weapon-discharges_2004-2018_2018-08_p456008'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_TRR-weapon-discharges_2004-2018_2018-08_p456008.csv.gz',
        'column_names_key': 'TRR-weapon-discharges_2004-2018_2018-08_p456008',
