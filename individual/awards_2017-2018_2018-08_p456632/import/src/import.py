...
def get_setup():
    ...
    args = {
        'input_file': 'input/P456632_awards_jul2017_to_15aug2018.csv',
        'output_file': 'output/awards_2017-2018_2018-08_p456632.csv.gz',
        'metadata_file': 'output/metadata_awards_2017-2018_2018-08_p456632.csv.gz',
        'column_names_key': 'awards_2017-2018_2018-08_p456632'
        }
