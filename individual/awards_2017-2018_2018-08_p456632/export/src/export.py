...
def get_setup():
    ...
    args = {
        ...
        'output_profiles_file': 'output/awards_2017-2018_2018-08_p456632_profiles.csv.gz',
        # 'export_cols': [
        ...
        #     ],
        'id': 'awards_2017-2018_2018-08_p456632_ID'
        }
...
profiles_df.loc[(profiles_df.first_name_NS == 'RCASE') & 
                (profiles_df.last_name == 'VERIFICATION'), 'merge'] = 0
