...
'''import script for complaints-CPD-witnesses-cms_2019-2021_2021-07_p21060299'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_cpd_witness_REDACTED.csv',
        'output_file': 'output/complaints-CPD-witnesses-cms_2019-2021_2021-07_p21060299.csv.gz',
        'metadata_file': 'output/metadata_complaints-CPD-witnesses-cms_2019-2021_2021-07_p21060299.csv.gz',
        'column_names_key': 'complaints-CPD-witnesses-cms_2019-2021_2021-07_p21060299',
        }
