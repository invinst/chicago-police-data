...
'''assign-unique-ids script for TRR-statuses_2004-2018_2018-08_p456008'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/TRR-statuses_2004-2018_2018-08_p456008.csv.gz',
        'output_file': 'output/TRR-statuses_2004-2018_2018-08_p456008.csv.gz',
        'output_profiles_file': 'output/TRR-statuses_2004-2018_2018-08_p456008_profiles.csv.gz',
        'id_cols': ['first_name_NS', 'last_name_NS', 'race', 'gender', 'appointed_date'],
        'incident_cols' : ['rank', 'star'],
        'list_cols': ['trr_id'],
        'id': 'TRR-statuses_2004-2018_2018-08_p456008_ID',
        }
