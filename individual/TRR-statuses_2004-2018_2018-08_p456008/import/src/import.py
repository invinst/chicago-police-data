...
'''import script for TRR-statuses_2004-2018_2018-08_p456008'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_TRR-statuses_2004-2018_2018-08_p456008.csv.gz',
        'column_names_key': 'TRR-statuses_2004-2018_2018-08_p456008',
        'sheet_name': 'Statuses_OtherMembers'
        }
...
if __name__ == "__main__":
    ...
    df = pd.read_excel(cons.input_file, sheet_name='Statuses_OtherMembers')
