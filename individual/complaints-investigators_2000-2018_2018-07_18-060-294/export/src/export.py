...
'''export script for complaints-investigators_2000-2018_2018-07_18-060-294'''
...
def get_setup():
    ...
    args = {
        ...
        'input_profiles_file': 'input/complaints-investigators_2000-2018_2018-07_profiles.csv.gz',
