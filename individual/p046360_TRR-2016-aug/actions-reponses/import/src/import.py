...
'''import script for p046360_TRR-2016-aug/actions-reponses'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/actions-responses.csv.gz',
        'metadata_file': 'output/metadata_actions-responses.csv.gz',
        'sheet': 'ActionsResponses',
        'column_names_key': 'p046360_TRR-2016-aug/actions-responses'
        }
