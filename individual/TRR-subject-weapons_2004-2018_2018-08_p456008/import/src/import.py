...
'''import script for TRR-subject-weapons_2004-2018_2018-08_p456008'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/TRR-subject-weapons_2004-2018_2018-08_p456008.csv.gz',
        'metadata_file': 'output/metadata_TRR-subject-weapons_2004-2018_2018-08_p456008.csv.gz',
        'column_names_key': 'TRR-subject-weapons_2004-2018_2018-08_p456008',
        'sheet_name': 'SubjectWeapons'
        }
...
if __name__ == "__main__":
    ...
    df = pd.read_excel(cons.input_file, sheet_name='SubjectWeapons')
