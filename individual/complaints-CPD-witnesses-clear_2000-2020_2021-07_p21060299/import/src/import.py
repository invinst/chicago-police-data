...
'''import script for complaints-CPD-witnesses-clear_2000-2020_2021-07_p21060299'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/clear_cpd_witness REDACTED.csv',
        'output_file': 'output/complaints-CPD-witnesses-clear_2000-2020_2021-07_p21060299.csv.gz',
        'metadata_file': 'output/metadata_complaints-CPD-witnesses-clear_2000-2020_2021-07_p21060299.csv.gz',
        'column_names_key': 'complaints-CPD-witnesses-clear_2000-2020_2021-07_p21060299',
        }
