...
'''import script for complaints-CPD-witnesses_2000-2023_2023-08_p053540'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/AllCPDWitness.xlsx',
        'output_file': 'output/complaints-CPD-witnesses_2000-2023_2023-08_p053540.csv.gz',
        'metadata_file': 'output/metadata_complaints-CPD-witnesses_2000-2023_2023-08_p053540.csv.gz',
        'column_names_key': 'complaints-CPD-witnesses_2000-2023_2023-08_p053540',
        }
