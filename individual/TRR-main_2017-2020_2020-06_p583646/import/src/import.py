...
'''import script for TRR-main_2017-2020_2020-06_p583646'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_TRR-main_2017-2020_2020-06_p583646.csv.gz',
        'sheet': 'TRRData',
        'keep_columns': [
            'TRR_REPORT_ID', 'RD_NO', 'BEAT', 'BLK', 'DIR', 'STN',
            'LOC', 'DATETIME', 'INDOOR_OR_OUTDOOR',
        ...
        'column_names_key': 'TRR-main_2017-2020_2020-06_p583646',
        }
