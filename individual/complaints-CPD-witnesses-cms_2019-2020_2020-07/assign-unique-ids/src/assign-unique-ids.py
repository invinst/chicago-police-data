...
'''assign-unique-ids script for complaints-CPD-witnesses-cms_2019-2020_2020-07'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/complaints-CPD-witnesses-cms_2019-2020_2020-07.csv.gz',
        'output_file': 'output/complaints-CPD-witnesses-cms_2019-2020_2020-07.csv.gz',
        'output_profiles_file': 'output/complaints-CPD-witnesses-cms_2019-2020_2020-07_profiles.csv.gz',
        'id_cols': ['first_name_NS', 'last_name_NS', 'middle_initial', 'birth_year', 'race', 'gender'],
        'incident_cols' : ['rank', 'current_unit'],
        'list_cols': ['cr_id'],
        'id': 'complaints-CPD-witnesses-cms_2019-2020_2020-07_ID',
        }
