...
'''import script for complaints-CPD-witnesses-cms_2019-2020_2020-07'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_cpd_witness_-_7.27.2020.csv',
        'output_file': 'output/complaints-CPD-witnesses-cms_2019-2020_2020-07.csv.gz',
        'metadata_file': 'output/metadata_complaints-CPD-witnesses-cms_2019-2020_2020-07.csv.gz',
        'column_names_key': 'complaints-CPD-witnesses-cms_2019-2020_2020-07',
        }
