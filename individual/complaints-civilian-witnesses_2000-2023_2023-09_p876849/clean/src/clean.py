...
'''clean script for complaints-civilian-witnesses_2000-2023_2023-09_p876849'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/complaints-civilian-witnesses_2000-2023_2023-09_p876849.csv.gz',
