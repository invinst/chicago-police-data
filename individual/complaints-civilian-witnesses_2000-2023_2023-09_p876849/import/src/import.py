...
'''import script for complaints-civilian-witnesses_2000-2023_2023-09_p876849'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/complaints-civilian-witnesses_2000-2023_2023-09_p876849.csv.gz',
        'metadata_file': 'output/metadata_complaints-civilian-witnesses_2000-2023_2023-09_p876849.csv.gz',
        'column_names_key': 'complaints-civilian-witnesses_2000-2023_2023-09_p876849',
        'sheet_name': "Non-CPD"
        }
