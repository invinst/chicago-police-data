...
'''import script for complaints-CPD-witnesses_2000-2018_2018-03_18-060-157'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_complaints-CPD-witnesses_2000-2018_2018-03.csv.gz',
        'column_names_key': 'complaints-CPD-witnesses_2000-2018_2018-03_18-060-157',
        'sheet' : 'CPD Witnesses'
        }
