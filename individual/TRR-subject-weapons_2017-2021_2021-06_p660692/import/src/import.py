...
'''import script for TRR-subject-weapons_2017-2021_2021-06_p660692'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/TRR-subject-weapons_2017-2021_2021-06_p660692.csv.gz',
        'metadata_file': 'output/metadata_TRR-subject-weapons_2017-2021_2021-06_p660692.csv.gz',
        'column_names_key': 'TRR-subject-weapons_2017-2021_2021-06_p660692',
        'sheet_name': 'June 2020 - May 20, 2021',
        'keep_cols': ['UFE REPORT NO', 'EVENT NO', 'RD', 'SUBJECT WEAPON USE', 'SUBJECTARMEDWITH', 
                    ]
        }
