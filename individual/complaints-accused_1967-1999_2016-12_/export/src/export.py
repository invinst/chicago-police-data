...
'''export script for complaints-accused_1967-1999_2016-12_'''
...
def get_setup():
    ...
    args = {
        ...
        'export_cols': [
            'cr_id', 'unit', 'complaint_category', 'rank_no',
            'complaint_description', 'final_finding', 'final_finding_desc',
            'final_discipline', 'final_discipline_desc'
            ],
