...
'''import script for TRR-main_2021-2023_2023-10_p877988'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/TRR-main_2021-2023_2023-10_p877988.csv.gz',
        'metadata_file': 'output/metadata_TRR-officers_2021-2023_2023-10_p877988.csv.gz',
        'column_names_key': 'TRR-main_2021-2023_2023-10_p877988',
        'main_sheet': 'Jan1-2021-Sep15-2023 TRR',
        'keep_columns': [
            'REPORT NO', 'TRR STATUS', 'INCIDENTDATETIME', 'RD_NO', 'EVENT_NO',
        'INDOOR_OR_OUTDOOR', 'LIGHTING_CONDITION',
        'WEATHER_CONDITION', 'NOTIFICATION_DISTOFOCCURR_I',
        'NOTIFICATION_IMMEDSUPER_I', 'NOTIFICATION_OEMC_I',
        'BEAT', 'LOCATION CODE', 'DIR', 'STREET NAME',
        'STREET NO']
    }
...
if __name__ == "__main__":
    ...
    df = pd.read_excel(cons.input_file, sheet_name=cons.main_sheet)
