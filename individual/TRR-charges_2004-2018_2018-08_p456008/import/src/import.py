...
'''import script for TRR-charges_2004-2018_2018-08_p456008'''
...
def get_setup():
    ...
    args = {
        ...
        'output_file': 'output/TRR-charges_2004-2018_2018-08_p456008.csv.gz',
        'metadata_file': 'output/metadata_TRR-charges_2004-2018_2018-08_p456008.csv.gz',
        'column_names_key': 'TRR-charges_2004-2018_2018-08_p456008',
        'sheet_name': 'Charges'
        }
