...
'''import script for complaints-complainants-cms_2019-2020_2020-07'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_complainant - 7.27.2020.csv',
        'output_file': 'output/complaints-complainants-cms_2019-2020_2020-07.csv.gz',
        'metadata_file': 'output/metadata_complaints-complainants-cms_2019-2020_2020-07.csv.gz',
        'column_names_key': 'complaints-complainants-cms_2019-2020_2020-07',
        }
