...
'''import script for complaints-complaints-cms_2019-2022_2022-09_p031093'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_case_info.xlsx',
        'output_file': 'output/complaints-complaints-cms_2019-2022_2022-09_p031093.csv.gz',
        'metadata_file': 'output/metadata_complaints-complaints-cms_2019-2022_2022-09_p031093.csv.gz',
        'column_names_key': 'complaints-complaints-cms_2019-2022_2022-09_p031093',
        }
