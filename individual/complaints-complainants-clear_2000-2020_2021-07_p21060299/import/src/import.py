...
'''import script for complaints-complainants-clear_2000-2020_2021-07_p21060299'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/clear_complainant.csv',
        'output_file': 'output/complaints-complainants-clear_2000-2020_2021-07_p21060299.csv.gz',
        'metadata_file': 'output/metadata_complaints-complainants-clear_2000-2020_2021-07_p21060299.csv.gz',
        'column_names_key': 'complaints-complainants-clear_2000-2020_2021-07_p21060299',
        }
