...
'''export script for complaints-CPD-witnesses-clear_2000-2020_2020-07'''
...
def get_setup():
    ...
    args = {
        ...
        'input_profiles_file': 'input/complaints-CPD-witnesses-clear_2000-2020_2020-07_profiles.csv.gz',
