...
'''import script for complaints-CPD-witnesses_2000-2023_2023-09_p876849'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_complaints-CPD-witnesses_2000-2023_2023-09_p876849.csv.gz',
        'column_names_key': 'complaints-CPD-witnesses_2000-2023_2023-09_p876849',
        'keep_cols': [
              'APPOINTED_DATE', 'Birth Year', 'CURRENT_POSITION_RANK', 'Cr Number', 'Current Status',
              'Current Unit', 'Position Rank', 'Race', 'Role', 'Sex', 'Star No', 'Unit at Time of CR'
        ],
        'sheet_name': "CPD_Members"
        }
