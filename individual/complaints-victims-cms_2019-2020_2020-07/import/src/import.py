...
'''import script for complaints-victims-cms_2019-2020_2020-07'''
...
def get_setup():
    ...
    args = {
        'input_file': 'input/cms_subject - 7.27.2020.csv',
        'output_file': 'output/complaints-victims-cms_2019-2020_2020-07.csv.gz',
        'metadata_file': 'output/metadata_complaints-victims-cms_2019-2020_2020-07.csv.gz',
        'column_names_key': 'complaints-victims-cms_2019-2020_2020-07',
        }
