...
'''import script for TRR-actions-responses_2017-2021_2021-06_p660692'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_TRR-actions-responses_2017-2021_2021-06_p660692.csv.gz',
        'column_names_key': 'TRR-actions-responses_2017-2021_2021-06_p660692',
        'sheet_name': 'June 2020 - May 20, 2021',
        'keep_cols': ['UFE REPORT NO', 'REASONFORRESPONSE NEW TRR', 'FORCEMITIGATIONEFFORTS NEW TRR',
                      'CONTROLTACTICS NEW TRR', 'RESPONSEWITHOUTWEAPONS NEW TRR', 'RESPONSEWITHWEAPON NEW TRR',
                      'SUBJECT ACTIONS NEW TRR']
        }
