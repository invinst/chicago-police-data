...
'''import script for complaints-investigators_2000-2018_2018-07_18-060-157'''
...
def get_setup():
    ...
    args = {
        ...
        'metadata_file': 'output/metadata_complaints-investigators_2000-2018_2018-07.csv.gz',
        'column_names_key': 'complaints-investigators_2000-2018_2018-07_18-060-294',
