...
'''assign-unique-ids script for settlements_1952-2016_2017-01_'''
...
def get_setup():
    ...
    args = {
        ...
        'output_demo_file': 'output/settlements_1952-2016_2017-01_profiles.csv.gz',
        'id_cols': [
            "first_name", "last_name",
            "first_name_NS", "last_name_NS", "star", "current_status",
            "officer_id", "service_years", "service_months",
