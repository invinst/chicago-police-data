...
'''export script for complaints-witnesses_2000-2016_2016-11_p046957'''
...
def get_setup():
    ...
    args = {
        ...
        'output_profiles_file': 'output/complaints-witnesses_2000-2016_2016-11_profiles.csv.gz',
        'export_cols': ['cr_id'],
...
profiles_df.loc[(profiles_df['first_name'].isnull() |
                 profiles_df['appointed_date'].isnull()), 'merge'] = 0
