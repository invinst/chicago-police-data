...
def test_resolve_units_case3():
    ...
    output_df = pd.DataFrame({
            'UID' : [100013, 100013, 100013, 100013],
...
def test_resolve_units_case4():
    ...
    output_df = pd.DataFrame({
            'UID' : [132333, 132333, 132333, 132333, 132333, 132333, 132333],
...
def test_resolve_units_case6():
    ...
    output_df = pd.DataFrame({
            'UID' : [100360, 100360, 100360, 100360, 100360, 100360, 100360, 100360, 100360],
...
def test_resolve_units_case7():
    ...
    output_df = pd.DataFrame({
            'UID' : [100618, 100618, 100618, 100618, 100618, 100618, 100618, 100618],
...
def test_resolve_units_case8():
    ...
    output_df = pd.DataFrame({
            'UID' : [100689, 100689, 100689, 100689, 100689, 100689, 100689, 100689],
...
def test_resolve_units_case9():
    ...
    output_df = pd.DataFrame({
            'UID' : [108635, 108635, 108635, 108635, 108635, 108635, 108635, 108635, 108635, 108635, 108635],
...
def test_resolve_units_case12():
    ...
    output_df = pd.DataFrame({
            'UID' : [100535, 100535, 100535, 100535],
