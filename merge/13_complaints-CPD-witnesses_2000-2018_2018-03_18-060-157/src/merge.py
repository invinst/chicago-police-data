...
def get_setup():
    ...
    args = {
        ...
        'input_remerge_file' : 'input/complaints-CPD-witnesses_2000-2018_2018-03.csv.gz',
        'output_remerge_file' : 'output/complaints-CPD-witnesses_2000-2018_2018-03.csv.gz',
        }
