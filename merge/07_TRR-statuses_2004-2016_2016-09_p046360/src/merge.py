...
'''merge script for 07_TRR-statuses_2004-2016_2016-09_p046360'''
...
def get_setup():
    ...
    args = {
        ...
        'input_remerge_file' : 'input/TRR-statuses_2004-2016_2016-09.csv.gz',
        'output_remerge_file' : 'output/TRR-statuses_2004-2016_2016-09.csv.gz'
        }
