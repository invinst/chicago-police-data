...
'''merge script for 27_roster_1985-2023_2023-11_p891976'''
...
def get_setup():
    ...
    args = {
        ...
        'universal_id': 'UID',
        'data_id': 'roster_1985-2023_2023-11_p891976_ID',
        'input_profiles_file' : 'input/roster_1985-2023_2023-11_p891976_profiles.csv.gz',
        ...
        'input_remerge_file' : 'input/roster_1985-2023_2023-11_p891976.csv.gz',
        'output_remerge_file' : 'output/roster_1985-2023_2023-11_p891976.csv.gz',
        }
